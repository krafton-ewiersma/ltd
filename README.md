...
- **Bots** (`server/bots.js`) roll random accuracy and reaction time; they chase each cube spawn, re-aiming until they hit. Bot rooms idle while no human is present, and scores reset when the last human leaves.
